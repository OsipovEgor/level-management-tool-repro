...
namespace Game.Levels.EditorTool
{
    public sealed class LevelNamePromptWindow : EditorWindow
    {
        ...
        public static void Show(
            ...
            Action onCancel)
        {
            var w = CreateInstance<LevelNamePromptWindow>();
            ...
            // Show as modal utility window (blocks editor interaction until closed)
            w.ShowModalUtility();
        }
        ...
        private void Validate()
        {
            ...
            var trimmed = (_name ?? string.Empty).Trim();
            ...
            // 1) Проверка по собранному списку имён LevelConfig
            ...
            // 2) Дополнительно: проверка коллизии именно в целевой папке (на случай других типов ассетов)
            var assetPath = $"{_folder}/{trimmed}.asset";
